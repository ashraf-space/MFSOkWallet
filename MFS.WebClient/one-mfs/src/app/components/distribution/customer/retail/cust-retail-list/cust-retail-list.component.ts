...
@Component({
  selector: 'app-cust-retail-list',
  templateUrl: './cust-retail-list.component.html',
  styleUrls: ['./cust-retail-list.component.css']
})
export class CustRetailListComponent implements OnInit {
    ...
    initialiseGridConfig(): any {
        ...
        this.gridConfig.dataSourcePath = this.mfsSettingService.distributionApiServer + '/Merchant/GetRetailList?filterId=';
        ...
        this.gridConfig.gridName = "Retail list";
        this.gridConfig.gridIconClass = 'fas fa-list';
        this.gridConfig.createStateUrl = 'retail/addoredit/';
        this.gridConfig.hasEditState = true;
        this.gridConfig.entityField = 'mphone';
        this.gridConfig.detailsStateUrl = 'retail/details/';
