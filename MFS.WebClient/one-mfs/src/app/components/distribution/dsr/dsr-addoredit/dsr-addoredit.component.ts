...
@Component({
    selector: 'app-dsr-addoredit',
    templateUrl: './dsr-addoredit.component.html',
    styleUrls: ['./dsr-addoredit.component.css'],
    encapsulation: ViewEncapsulation.None
})
export class DsrAddoreditComponent implements OnInit {
    regInfoModel: any = {};
