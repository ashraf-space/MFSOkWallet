...
@Component({
  selector: 'app-b2b-dsr-list',
  templateUrl: './b2b-dsr-list.component.html',
  styleUrls: ['./b2b-dsr-list.component.css']
})
export class B2bDsrListComponent implements OnInit {
