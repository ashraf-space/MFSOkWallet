...
@Component({
  selector: 'app-rpt-mms',
  templateUrl: './rpt-mms.component.html',
  styleUrls: ['./rpt-mms.component.css']
})
export class RptMmsComponent implements OnInit {
    ...
    getReportParam() {
        if (this.validate()) {
            ...
            if (!this.model.memberId) {
                ...
                obj.memberId = this.model.memberId
            }
            if (!this.model.orgId) {
                obj.orgId = null;
            }
            else {
                obj.orgId = this.model.orgId
            }
