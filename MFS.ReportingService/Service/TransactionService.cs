...
namespace MFS.ReportingService.Service
{
    ...
    public class TransactionService : BaseService<AccountStatement>, ITransactionService
    {
        ...
        public List<AccountStatement> GetAccountStatementList(string mphone, string fromDate, string toDate, string balanceType)
        {
            try
            {
                return this._TransactionRepository.GetAccountStatementList(mphone, fromDate, toDate, balanceType);
            }
            catch (Exception)
            {
        ...
        {
            return _TransactionRepository.GetCampaignTypeDDL();
        }
        ...
        {
            return _TransactionRepository.GetReferralCampaignList(tansactionType, campaignType, fromDate, toDate);
        }

        public List<BtclTelephoneBill> GetBtclTelephoneBill(string fromDate, string toDate)
        {
            return _TransactionRepository.GetBtclTelephoneBill(fromDate, toDate);
        }

        public List<AdmissionFeePayment> GetadmissionFeePaymentList(string fromDate, string toDate)
        {
            return _TransactionRepository.GetadmissionFeePaymentList(fromDate, toDate);
        }
        public List<DisbursementVoucher> GetDisbursementVoucherList(string option,string disTypeId, string fromDate, string toDate)
        {
            return _TransactionRepository.GetDisbursementVoucherList(option, disTypeId, fromDate, toDate);
        }
        ...
        {
            return _TransactionRepository.GetB2BCollectionDtlSummaryList(tansactionType, fromCat, toCat, fromDate, toDate);
        }
